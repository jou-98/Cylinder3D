...
def main(args):
    ...
    train_dataset_loader, val_dataset_loader = data_builder.build(dataset_config,
                                                                  ...
                                                                  grid_size=grid_size)
    print(f'Data builder finished initializing dataloaders, took {time.time()-ckpt}s')
    ckpt = time.time()
    ...
    while epoch < train_hypers['max_num_epochs']:
        ...
        for i_iter, (_, train_vox_label, train_grid, _, train_pt_fea) in enumerate(train_dataset_loader):
            ...
            loss = lovasz_softmax(torch.nn.functional.softmax(outputs), point_label_tensor, ignore=0,classes=[1]) + loss_func(
...
if __name__ == '__main__':
    ...
    parser.add_argument('-y', '--config_path', default='config/bolts.yaml')
